...
module.exports.strings = {
  ...
  ADMIN_CLEAR_WISHLISTS_DESCRIPTION: 'Diese Aktion wird sofort und <b>unwiederbringlich alle Wunschlisten löschen!</b> Mache am besten ein Datenbankbackup, bevor Du fortfährst.',
  ADMIN_CLEAR_WISHLISTS_HEADER: 'Wunschlistenlöschung',
  ...
  WISHLIST_IMAGE: 'Bild',
  WISHLIST_MOVE_DOWN: 'Nach unten verschieben',
  WISHLIST_MOVE_GUARD: 'Falscher Nutzer',
  WISHLIST_MOVE_INVALID: 'Ungültige Verschiebung',
  WISHLIST_MOVE_ITEM_DOWN: 'Eintrag nach unten verschieben',
  WISHLIST_MOVE_ITEM_TOP: 'Eintrag an den Anfang verschieben',
  WISHLIST_MOVE_ITEM_UP: 'Einstrag nach oben verschieben',
  WISHLIST_MOVE_SUCCESS: 'Eintrag erfolgreich verschoben!',
  WISHLIST_MOVE_TOP: 'An den Anfang verschieben',
  WISHLIST_MOVE_UP: 'Nach oben verschieben',
  WISHLIST_NAME: 'Name',
  WISHLIST_NOTE: 'Bemerkung',
  WISHLIST_OPTIONAL: 'Optional',
  WISHLIST_PLEDGE_DUPLICATE: 'Eintrag ist bereits reserviert',
  WISHLIST_PLEDGE_ITEM: 'Eintrag reservieren',
  ...
  WISHLIST_URL_LABEL: 'Eintrags-URL oder Name (<a href="/supported-sites">Unterstützte Seiten</a>)',
  WISHLIST_URL_PLACEHOLDER: 'https://www.amazon.com/dp/B00ZV9RDKK',
  WISHLIST_URL_REQUIRED: 'Eintrags-URL oder Name wird benötigt',
