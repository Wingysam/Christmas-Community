...
module.exports.strings = {
  ...
  ADMIN_SETTINGS_GROUPS_ADD_HEADER: 'Add group',
  ADMIN_SETTINGS_GROUPS_ADD_GROUPNAME: 'Groupname',
  ADMIN_SETTINGS_GROUPS_ADD_PLACEHOLDER: 'Ace',
  ADMIN_SETTINGS_GROUPS_ADD_BUTTON: 'Add Group',
  ADMIN_SETTINGS_GROUPS_REMOVE_FROM_GROUP: 'Remove from Group',
  ADMIN_SETTINGS_GOUPS_MIGRATE_TO_DESCRIPTION:'Warning beta feature be sure you have a working backup before migrating',
