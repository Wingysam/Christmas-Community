...
export const strings = {
  ...
  ADMIN_CLEAR_WISHLISTS_DESCRIPTION:
    '<b>Advarsel</b>: Dette vil <b>slette alt data</b>! Foretag venligst backup inden du fortsætter.',
  ...
  ADMIN_SETTINGS_USERS_EDIT_PROMOTE_ALREADY_ADMIN:
    'Brugeren er allerede administrator',
  ...
  ADMIN_USER_EDIT_RESET_PASSWORD_HASLINK:
    'Der eksistere ikke et gendannelseslink for denne bruger',
  ...
  CONFIRM_ACCOUNT_EXPIRED:
    'Dit bekræftelseslink er udløbet. Kontakt venligst administoren for et nyt.',
  ...
  CONFIRM_ACCOUNT_INVALID:
    'Bekræftelseslinket er ikke gyldigt - kontrollér venligst at linket er komplet.',
  CONFIRM_ACCOUNT_SET_PW_BUTTON: 'Opret bruger',
  CONFIRM_ACCOUNT_SET_PW_PLACEHOLDER: 'pa$$word!',
  CONFIRM_ACCOUNT_SET_PW_TEXT: (name) =>
    `Hej ${name}! Vælg venligst din adgangskode her.`,
  ...
  PROFILE_PASSWORD_TITLE: (name) =>
    `Profilindstillinger - Adgangskode - ${name}`,
  ...
  RESET_PASSWORD_GREETING_EXPIRED:
    'Gendannelseslinket er udløbet. Kontakt administrator for at få et nyt.',
  RESET_PASSWORD_GREETING_INVALID:
    'Ugyldigt gendannelseslink - kontrollér venligst at linket er komplet.',
  RESET_PASSWORD_GREETING_VALID: (name) =>
    `Hej ${name}! Vælg din nye adgangskode her.`,
