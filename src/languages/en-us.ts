...
export const notTranslated = (englishString) =>
  `${englishString} (not yet translated into English)`

export const strings = {
  ADMIN_CLEAR_WISHLISTS_BUTTON: 'Clear all wishlists',
  ADMIN_CLEAR_WISHLISTS_DESCRIPTION:
    'This will instantly <b>irreversibly delete all wishlists!</b> Consider making a backup of the database before using this.',
  ...
  ADMIN_SETTINGS_CLEARDB_DESCRIPTION:
    '<b>Warning</b>: These options <b>destroy data</b>! You may want to back up the database before using these options.',
  ...
  ADMIN_SETTINGS_USERS_EDIT_DELETE_SUCCESS: (name) =>
    `Successfully removed user ${name}`,
  ...
  ADMIN_USER_EDIT_LINK_EXPIRY_FUTURE: (fromNow) =>
    `The following link expires ${fromNow}`, // fromNow is localized by moment
  ADMIN_USER_EDIT_LINK_EXPIRY_PAST: (fromNow) =>
    `The following link expired ${fromNow}`,
  ...
  ADMIN_USER_EDIT_RESET_PASSWORD_HASLINK:
    'There is a reset password link for this user.',
  ...
  CONFIRM_ACCOUNT_EXPIRED:
    'Your confirmation link has expired. Please ask for a new one.',
  ...
  CONFIRM_ACCOUNT_INVALID:
    "This confirmation link isn't valid, perhaps the account was deleted or some characters at the end got cut off?",
  ...
  SUPPORTED_SITES_TEXT:
    'Is a site missing or broken? Open an issue <a href="https://github.com/Wingysam/get-product-data/issues/new">here</a>! :)',
